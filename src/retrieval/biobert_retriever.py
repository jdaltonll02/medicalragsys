"""
BioBERT dense retriever using FAISS
"""
...
class BioBERTRetriever:
    """Dense retriever that queries FAISS using BioBERT embeddings"""
    ...
    def retrieve(self, query_embedding: np.ndarray, top_k: int = 50) -> List[Dict[str, Any]]:
        """
        Retrieve top documents using FAISS on BioBERT embeddings.
