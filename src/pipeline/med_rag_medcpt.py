"""
Medical RAG Pipeline - MedCPT retriever variant (dense-only)
"""
...
class MedicalRAGPipelineMedCPT:
    """End-to-end Medical RAG Pipeline using MedCPT dense retriever"""
    ...
    def _initialize_components(self):
        ...
        self.medcpt_retriever = MedCPTRetriever(self.faiss_index)
    ...
    def index_documents(self, documents: List[Dict[str, Any]]):
        """Build dense FAISS index with MedCPT embeddings"""
        if not documents:
            return
    ...
    def process_query(
        ...
        dense_results = self.medcpt_retriever.retrieve(query_embedding, top_k=top_k_final)
